...
export function Home() {
  return (
    <Layout footer={false}>
      ...
      <div
        aria-hidden="true"
        className="fixed inset-0 pointer-events-none -z-10 bg-[#f6f4ee]/72 md:bg-transparent md:bg-[linear-gradient(105deg,rgba(246,244,238,0.85)_0%,rgba(246,244,238,0.6)_45%,rgba(246,244,238,0.1)_100%)]"
      />
