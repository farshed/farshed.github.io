...
// Brand icons were removed from lucide; these are the original lucide paths inlined
...
export function ResumeV2({ cssHref }: { cssHref: string }) {
  return (
    <html lang="en">
      <head>
        <meta charSet="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Faisal Arshed - Resume</title>
      ...
      <body className="bg-gray-5 text-black">
