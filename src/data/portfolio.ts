...
export const projects: PortfolioProject[] = [
  {
    title: 'Erdos',
    description: 'Financial analytics terminal and asset portfolio management platform.',
  ...
  },
  {
    ...
    thumbnail:
      'https://raw.githubusercontent.com/farshed/SoundSpice-mobile/master/docs/screenshots.png',
    githubUrl: 'https://github.com/farshed/soundspice-mobile'
  },
  {
    title: 'Duofolio',
    description:
    ...
    thumbnail: 'https://raw.githubusercontent.com/farshed/duofolio/master/docs/screenshots.png',
    githubUrl: 'https://github.com/farshed/duofolio'
  },
  {
  ...
  {
    title: 'Turnable (acquired)',
    description: 'Automated compliance monitoring and reporting system for financial institutions.',
    loomUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    writeup:
  ...
  {
    title: 'Wx (by Sodexo)',
    description: 'Workplace experience insights platform.',
    loomUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    writeup:
      'Developed an agentic AI system that monitors compliance across multiple regulatory frameworks (AML, KYC, GDPR). The system autonomously flags suspicious activities, generates compliance reports, and updates policies based on new regulations. Built with microservices architecture and integrated with major regulatory databases.',
    tags: ['Fintech', 'Agentic AI', 'Compliance'],
