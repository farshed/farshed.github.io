...
This realization is our sense of 'self'. In Freudian terms, this is our _ego_ (Latin for "self"). It starts to form as the child interacts with the external world and learns that not all needs can be immediately satisfied. The ego's role is to mediate between the demands of the _id_ (rhymes with "kid" - our primal instinct that operates on the [pleasure principle](<https://en.wikipedia.org/wiki/Pleasure_principle_(psychology)>)) and the constraints of the external world in a socially acceptable way.
